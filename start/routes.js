...
Route.post('/api/search-email/:pages/:limit', 'StudentController.searchStudent').middleware('auth:admin')  // Admin
...
Route.get('/api/mercadopago-transaction/:id', 'MercadoPagoController.getPaymentbyTransactionId')   // Admin
